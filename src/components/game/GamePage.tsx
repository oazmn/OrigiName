        ...
        <div className="max-w-sm w-full text-center relative z-10">
          ...
          <div className="grid grid-cols-3 gap-2.5 mb-8">
            {[
              ...
              { icon: <img src="/OrigiName/icon-map.svg" alt="map" className="w-8 h-8 mx-auto" />, text: "Pin its origin" },
              { icon: <img src="/OrigiName/icon-trophy.svg" alt="trophy" className="w-8 h-8 mx-auto" />, text: "Score points" },
            ].map(({ icon, text }) => (
              <div
                key={text}
            ...
            <div className="bg-gray-950/92 backdrop-blur-xl border border-white/10 rounded-2xl px-6 py-4 text-center shadow-2xl shadow-black/60 ring-1 ring-white/5">
              ...
              {state.hint ? (
                <div className="flex items-center justify-center gap-1.5 bg-amber-500/10 border border-amber-500/20 rounded-xl px-3 py-2">
                  <img src="/OrigiName/icon-hint.svg" alt="hint" className="w-4 h-4" />
